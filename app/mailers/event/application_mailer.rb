...
class Event
  class ApplicationMailer < ::ApplicationMailer
    ...
    def incomplete
      tips = [
        "Each Fuime organization gets a free online donation page that can be used to raise funds. All donors need is a credit card, and you can customize the page however you'd like!",
        "Fuime allows you to get reimbursed for out-of-pocket expenses towards your organization's mission.",
      ...
      mail to: @application.user.email_address_with_name, subject: "[Action Needed] Complete your Fuime application!"
    end
