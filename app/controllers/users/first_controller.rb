  ...
  class FirstController < ApplicationController
    ...
    def index
      ...
      @advisor_email_body = <<~EMAIL
        At Championships this year, I met a couple of engineers from a nonprofit, Hack Club. They run a service called Fuime and they pitch it as "the ultimate booster club for FRC, FTC, and FLL teams."
