    ...
    def self.commands
      [
        ...
        },
        {
          name: "link",
          type: Discordrb::ApplicationCommand::TYPES[:chat_input],
          description: "Link your Discord account to your Fuime account",
          options: [],
          meta: { ephemeral: true },
        },
        {
          name: "setup",
          type: Discordrb::ApplicationCommand::TYPES[:chat_input],
          description: "Connect your Discord server to your Fuime organization",
          options: [],
          meta: { ephemeral: true },
        },
        {
          name: "balance",
          type: Discordrb::ApplicationCommand::TYPES[:chat_input],
          description: "Check your organization's balance on Fuime",
          options: [],
          meta: { ephemeral: false },
        },
        {
          name: "transactions",
          type: Discordrb::ApplicationCommand::TYPES[:chat_input],
          description: "View your organization's recent transactions on Fuime",
          options: [],
          meta: { ephemeral: false },
        },
        {
