...
class FlavorTextService
  ...
  def holiday_flavor_texts
    [
      ...
      "defrosting...",
      "send snow photos to support@fuime.com",
  ...
  def flavor_texts
    [
      ...
      "Send your jokes to support@fuime.com",
      "Cha-ching!",
      "Hey there cutie!",
      ...
      "Wanna&nbsp;<a href='#{Rails.configuration.constants.github_url}' target='_blank' style='color: inherit'>see the code</a>?".html_safe,
