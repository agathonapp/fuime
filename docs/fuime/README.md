...
| **ADMIN_OPS_QUEUES.md** | Spec for the admin queues Fuime's own money model needs (failed payouts, connected-account status, stuck guardianships, past-due subscriptions). | **Partially built** — §4 subscriptions shipped 2026-08-21; §1–§3 still unbuilt. See TEEN_GROWTH_GAPS.md G5/G11. | Status block in the doc matches this row (§4 shipped; §1–§3 unbuilt). |
