...
| **ONBOARDING_PLAN.md** | The teen and parent onboarding flows as they are on `main`, the target flows with proposed copy, and the phased PR list to get there. | **"How do we make signup and the parent sign-off the easiest part of Fuime?"** Read before touching signup, the application wizard, guardian invites or guardian pages. | Sep 2026. Current. Phase A shipped 2026-09-11 (see its status line); B–D open. |
