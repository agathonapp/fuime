...
| **ONBOARDING_PLAN.md** | Target teen flow, five moves, PR order, and what must not move (2026-09-11). | **The plan of record for signup → first draft offer.** Follow this; do not invent a competing onboarding philosophy. | Sep 2026. Current. |
