...
| **TESTING_WALKTHROUGH.md** | 15-minute “test everything” path: `rake fuime:demo:seed`, the `demo+…@fuime.test` cast, every admin queue, MoR checkout, billing. | **How Rushmore clicks the product without real users.** Stripe test only. | Sep 2026. Current. |
